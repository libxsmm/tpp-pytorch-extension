...
#python -u -W ignore eval_hetero.py --batch_size $1 --use_tpp --use_bf16 --use_qint8_gemm --checkpoint $2 --fan_out $3 --validation_frac $4 --data_type $5 --dataset_size $6 --path /scratch/savancha/IGBH
