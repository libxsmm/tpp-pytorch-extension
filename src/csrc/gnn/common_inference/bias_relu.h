...
RECORD_FUNCTION("bias_relu", std::vector<c10::IValue>());
...
#pragma omp for
      for (int n = 0; n < N; n++) {
        ...
        relu_tpp(tmp, out[n], relu_mask[n]);
      }
    }
  }
}
