...
RECORD_FUNCTION("bias_lrelu", std::vector<c10::IValue>());
...
#pragma omp for
      for (int n = 0; n < N; n++) {
        ...
        lrelu_tpp(tmp, out[n], lrelu_mask[n]);
      }
    }
  }
}
